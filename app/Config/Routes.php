 ...
 * --------------------------------------------------------------------
 */
$routes->get('/', 'Treklist::index');
$routes->get('/trekslist', 'Treklist::trekslist');
$routes->get('/trekItinerary', 'Treklist::trekitinerary');
$routes->get('/getfaq/(:any)', 'Treklist::getfaq/$1');
$routes->get('/addTrek', 'Treklist::addTrek');
$routes->get('/gettrek/(:any)', 'Treklist::gettrek/$1');
$routes->get('/gettrekitinerary/(:any)', 'Treklist::gettrekitinerary/$1');
$routes->get('/deletetrekitinerary/(:any)', 'Treklist::deletetrekitinerary/$1');
$routes->get('/deleteTrek/(:any)', 'Treklist::deletetrek/$1');
$routes->post('/edittrek', 'Treklist::updateTrek');
