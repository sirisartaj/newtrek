...
define('UPLOADFILEPATH', $_SERVER['DOCUMENT_ROOT'] . '/admin/riding/public/uploads/');
define('UPLOADPATH', $_SERVER['DOCUMENT_ROOT'] .'/admin/riding/public/uploads/');
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/admin/riding/public/');
