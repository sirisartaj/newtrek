...
define('UPLOADFILEPATH', $_SERVER['DOCUMENT_ROOT'] . '/newtrek/riding/public/uploads/');
define('UPLOADPATH', $_SERVER['DOCUMENT_ROOT'] .'/newtrek/riding/public/uploads/');
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/newtrek/riding/public/');
